    ...
    template: `
            <div>
                ...
                <table>
                    ...
                    <tr>
                        <td><span>快捷控制</span></td>
                        <td><input type="checkbox" class="check-switch check-switch-anim" v-model="widgets[7].show"></td>
                    </tr>
                    <tr>
                        <td><span>硬盘&内存占用显示</span></td>
                        <td><input type="checkbox" class="check-switch check-switch-anim" v-model="widgets[8].show"></td>
                    </tr>
                </table>
                <div class="save" @click="save">保存</div>
            </div>
